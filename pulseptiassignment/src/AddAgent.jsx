...
const AddAgent = () => {
  ...
  const addagent = () => {
    Axios.post("https://localhost:3002/addagent", {
      parentagentid: parentagentid,
      username: username,
      password: password,
      subagentname: subagentname,
      contactnum: contactnum,
      monthlyptt: monthlyptt,
      quarterlyptt: quarterlyptt,
      halfylyptt: halfylyptt,
      yearlyptt: yearlyptt,
      onetimeptt: onetimeptt,
      monthlydap: monthlydap,
      quarterlydap: quarterlydap,
      halfylydap: halfylydap,
      yearlydap: yearlydap,
      onetimedap: onetimedap,
      monthlycsap: monthlycsap,
      quarterlycsap: quarterlycsap,
      halfylycsap: halfylycsap,
      yearlycsap: yearlycsap,
      onetimecsap: onetimecsap,
    }).then(() => {
      console.log("success");
    });
  };
